        ...
        >
          ...
          <div className="relative mx-auto max-w-5xl px-6">
            ...
            <div className="grid gap-12 md:grid-cols-[1fr_1.2fr] md:gap-16 items-start mb-16">
              ...
              >
                {`Without financial causality and statistical rigor, most signals are crowded reflections of information already priced in. 
                We move beyond reactive heuristics to isolate the structural drivers of market states, transforming high-probability setups 
                into dynamically optimized positioning.`}
              </motion.p>
